...
function resolvePublicPath(urlPath) {
  ...
  // Local preview alias used by Codex/browser previews.
  // It serves the same public files without exposing the project root.
  if (decodedPath === "/preview-local" || decodedPath.startsWith("/preview-local/")) {
    decodedPath = decodedPath.slice("/preview-local".length) || "/";
  }
